function concentric_grating_experiment_white_screen_trigger_reverse(fileName, isLive)
...
try
    ...
    for jFrame=1:nFramesInCycle
        ...
        grating = white*ones(screen.resolutionX, screen.resolutionY);
    ...
    for iTrl=1:nTrials
        ...
        frameTexId = ones(nFramesTotal(iTrl),nFramesInCycle)+1;
...
%             Screen('DrawingFinished', window);
        ...
        for jFrame=1:nFramesTotal(iTrl)
            ...
            if jFrame>=1 && jFrame<shiftFrame(iTrl)
        ...
        log.setShiftframe(iTrl) = shiftFrame(iTrl); % set duration till shift
