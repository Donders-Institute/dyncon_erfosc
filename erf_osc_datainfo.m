...
pilotsubjects(1).segmentedmri = '/home/electromag/matves/Data/ERF_oscillation/sMRI/pilot/01/98944/segmentedmri.mat';
pilotsubjects(1).ecgcomp = [1, 2, 8, 28];
pilotsubjects(1).eyecomp = [];
...
pilotsubjects(2).segmentedmri = '/home/electromag/matves/Data/ERF_oscillation/sMRI/pilot/02/105520/segmentedmri.mat';
pilotsubjects(2).ecgcomp = [4, 7, 33];
pilotsubjects(2).eyecomp = [];
...
pilotsubjects(3).segmentedmri = '/home/electromag/matves/Data/ERF_oscillation/sMRI/pilot/03/101497/segmentedmri';
pilotsubjects(3).ecgcomp = [3, 13];
pilotsubjects(3).eyecomp = [];
...
pilotsubjects(103).segmentedmri = '/home/electromag/matves/Data/ERF_oscillation/sMRI/pilot/03/101497/segmentedmri';
pilotsubjects(103).ecgcomp = [3, 26];
pilotsubjects(103).eyecomp = [];
