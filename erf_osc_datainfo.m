...
%% Experiment
badsubjects = [8, 10]; %5 (dental fillings left temporal),  8 eyesaccades, 10 (corrupt logfile, only 9 blocks completed, many eye blinks)
