...
% save
if isPilot
    save(sprintf('/home/electromag/matves/Data/ERF_oscillation/artifacts/pilot/%02d/icaComp.mat', subj), 'comp');
else
    save(sprintf('/home/electromag/matves/Data/ERF_oscillation/artifacts/experiment/%02d/icaComp.mat', subj), 'comp');
end
