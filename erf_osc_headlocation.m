...
%% save
if isPilot
    filename = sprintf('/home/electromag/matves/Data/ERF_oscillation/behavioral_log/pilot/pilot_headposition_%02d', subj);
else
    filename = sprintf('/home/electromag/matves/Data/ERF_oscillation/behavioral_log/experiment/headposition_%02d', subj);
end
