...
%% save
if ~exist(sprintf('/project/3011085.02/Results/freq/%02d', subj), 'dir');
    mkdir(sprintf('/project/3011085.02/Results/freq/%02d', subj));
end
filename = sprintf('/project/3011085.02/Results/freq/%02d/gamma_peak_%d', subj, subj);
